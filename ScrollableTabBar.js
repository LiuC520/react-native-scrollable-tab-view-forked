...
const ScrollableTabBar = createReactClass({
	...
	renderTab(child, page, isTabActive, onPressHandler, onLayoutHandler) {
		const {activeTextColor, inactiveTextColor, textStyle, activeTextStyle = {}, activeTabStyle = {}} = this.props;
		const textColor = isTabActive ? activeTextColor : inactiveTextColor;
		const fontWeight = isTabActive ? "bold" : "normal";
		const atextStyle = isTabActive ? activeTextStyle : {};
		const actTabStyle = isTabActive ? activeTabStyle : {};
		...
		return (
			...
			>
				<View style={[styles.tab, this.props.tabStyle]}>
					<Text style={[{color: textColor, fontWeight}, textStyle, atextStyle]}>{child.tabLabel}</Text>
				</View>
			</Button>
		);
	},
	...
	render() {
		...
		return (
			<View style={[styles.container, {backgroundColor: this.props.backgroundColor}, this.props.style]} onLayout={this.onContainerLayout}>
				<ScrollView
					ref={(scrollView) => {
				...
				>
					<View style={[styles.tabs, {width: this.state._containerWidth}, this.props.tabsContainerStyle]} ref="tabContainer" onLayout={this.onTabContainerLayout}>
